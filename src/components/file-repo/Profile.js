...
import { Navbar, Nav, NavDropdown, Form, FormControl, Alert, Container, InputGroup, Button, Table, Row, Col } from "react-bootstrap"
                            ...
                            <Form onSubmit={handleSubmit}>
                                <Row className="pb-4">
                                    ...
                                    <Col sm={12} className="mt-2">
                                        ...
                                        <Form.Control
                                            className={["mt-2", styles.accountInput]}
                                            type="password"
                                            ref={passwordRef}
                                ...
                                <Row className="d-flex justify-content-center align-items-center pb-4">
                                    <Col xs={6} className="mt-2 text-end">
                                        <Button type='submit' variant="primary" disabled={loading} className={styles.profileBtnPrimary}>
                                            <span>
                                                Update
                                            </span>
                                        </Button>
                                    ...
                                    <Col xs={6} className="mt-2 text-start">
                                        <Button variant="danger" className={styles.profileBtnDanger}>
                                            <span>
                                                <Link to="/" className='text-deco '>
                                                    Cancel
                                                </Link>
