...
export default function CreateAccount() {
	...
	const assignedPhaseRef = useRef();
	const assignedLevelRef = useRef();
	const assignedAreaRef = useRef();
								...
								>
									...
									<Row className="pb-4">
										<Col sm={4}>
											...
											<Dropdown ref={assignedPhaseRef} required>
												<Dropdown.Toggle
													variant="success"
													id="assigned-phase"
													className={[
										...
										<Col sm={4}>
											...
											<Dropdown ref={assignedLevelRef} required>
												<Dropdown.Toggle
													variant="success"
													id="assigned-level"
													className={[
										...
										<Col sm={4}>
											...
											<Dropdown ref={assignedAreaRef} required>
												<Dropdown.Toggle
													variant="success"
													id="assigned-area"
													className={[
